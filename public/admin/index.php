...
try {
  $pdo = brighton_pdo();
  foreach (["powers","items","rpg_factions","rules_sections","gm_lore","enemies","wargame_factions","wargame_units"] as $t) {
...
$body .= "<div class='row'>
  ...
  <div class='card'><strong>Rules</strong><div class='muted'>" . h((string)($counts["rules_sections"] ?? "?")) . " rows</div><a class='btn' href='rules.php'>Manage</a></div>
  <div class='card'><strong>GM Lore</strong><div class='muted'>" . h((string)($counts["gm_lore"] ?? "?")) . " rows</div><a class='btn' href='gm-lore.php'>Manage</a></div>
  <div class='card'><strong>Enemies</strong><div class='muted'>" . h((string)($counts["enemies"] ?? "?")) . " rows</div><a class='btn' href='enemies.php'>Manage</a></div>
